        ...
        <TouchableOpacity onPress={() => shouldSelect(inputKey)}>
            <StyledBox style={{ borderColor: strokeColor }}>
                <Flex p={2} flexDirection="row" justifyContent="space-between">
                    <Sans color="black100" size="2">{title}</Sans>
                ...
                <Box p={2}>
                    <Sans color="black100" size="3">${price}</Sans>
                    <Sans color="black50" size="1">per \ month</Sans>
                    <Spacer mb={3} />
                    <Sans color="black100" size="2">{subtitle}</Sans>
                    <Sans color="black50" size="1">{description}</Sans>
                </Box>
                <Spacer mb={1} />
            </StyledBox>
        </TouchableOpacity>
