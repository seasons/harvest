...
import { ScrollView, KeyboardAvoidingView, TouchableWithoutFeedback } from "react-native"
        ...
        <Container insetsBottom={false} insetsTop={false}>
            ...
            <Flex style={{ flex: 1 }}>
                ...
                <Flex flexDirection="column" style={{ flex: 1 }}>
                    <Box p={2} mt={5}>
                        {/* <KeyboardAwareScrollView keyboardDismissMode="none" showsVerticalScrollIndicator={false}> */}
