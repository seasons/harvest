...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EXFileSystem/EXFileSystem.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXFont/EXFont.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXKeepAwake/EXKeepAwake.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXLinearGradient/EXLinearGradient.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXLocation/EXLocation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXPermissions/EXPermissions.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXSQLite/EXSQLite.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Permission-Notifications/Permission_Notifications.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNSentry/RNSentry.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-pusher-push-notifications/react_native_pusher_push_notifications.framework"
